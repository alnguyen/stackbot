var Botkit = require('../lib/CoreBot')
var request = require('request')
var express = require('express')
var bodyParser = require('body-parser')
var worker = require('../lib/Slackbot_worker')
var publicDir = '../lib/public'
...
function Slackbot (configuration) {
  ...
  slack_botkit.configureSlackApp = function (slack_app_config, cb) {
    ...
    if (!slack_app_config || !slack_app_config.clientId ||
      ...
      throw new Error('Missing oauth config details', slack_botkit)
    } else {
  ...
  slack_botkit.setupWebserver = function (port, cb) {
    ...
    slack_botkit.webserver.use(express.static(publicDir))
